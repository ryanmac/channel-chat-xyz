    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <motion.h2 className="text-4xl font-bold mb-12 text-center text-gray-800" {...fadeIn}>
              Key Features
            </motion.h2>
        ...
        <section className="py-24 bg-gradient-to-b from-gray-100 to-white">
          <motion.div className="container mx-auto px-4 text-center" {...fadeIn}>
            <h2 className="text-4xl font-bold mb-6 text-gray-800">Enhance Your YouTube Experience</h2>
            <p className="text-xl mb-10 max-w-2xl mx-auto text-gray-600">
              ChannelChat adds a new dimension to the creator-audience relationship. Dive into deeper conversations, gain unique insights, and connect with content like never before.
            </p>
            <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105">
              Start Chatting Now
            </Button>
          </motion.div>
        </section>
